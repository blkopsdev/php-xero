...
var endpoint = [
    ...
    {name: "Reports",action:[{name: "TenNinetyNine"},{name: "AgedPayablesByContact"},{name: "AgedReceivablesByContact"},{name: "BalanceSheet"},{name: "BankStatement"},{name: "BankSummary"},{name: "BudgetSummary"},{name: "ExecutiveSummary"},{name: "ProfitAndLoss"},{name: "TrialBalance"}]},
...
function loadGet(appName,logoutUrl,currEndpoint,currAction) 
{
    ...
    var data = {name: appName,logoutUrl: logoutUrl};
